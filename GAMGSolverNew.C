...
namespace Foam
{
    defineTypeNameAndDebug(GAMGSolverNew, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<GAMGSolverNew>
        addGAMGSolverNewMatrixConstructorToTable_;

    lduMatrix::solver::addasymMatrixConstructorToTable<GAMGSolverNew>
...
Foam::GAMGSolverNew::GAMGSolverNew
(
...
void Foam::GAMGSolverNew::readControls()
{
    lduMatrix::solver::readControls();

    controlDict_.readIfPresent("cycleMode", cycleMode_);
...
const Foam::lduMatrix& Foam::GAMGSolverNew::matrixLevel(const label i) const
{
    return i ? matrixLevels_[i-1] : matrix_;
}


const Foam::lduInterfaceFieldPtrsList& Foam::GAMGSolverNew::interfaceLevel
(
    const label i
) const
{
...
Foam::GAMGSolverNew::interfaceBouCoeffsLevel
(
    const label i
) const
{
...
const Foam::FieldField<Foam::Field, Foam::scalar>&
Foam::GAMGSolverNew::interfaceIntCoeffsLevel
(
    const label i
) const
{
