...
void Foam::GAMGSolverNew::agglomerateMatrix
(
...
void Foam::GAMGSolverNew::agglomerateInterfaceCoefficients
(
    const label fineLevelIndex,
    const lduInterfacePtrsList& coarseMeshInterfaces,
    PtrList<lduInterfaceField>& coarsePrimInterfaces,
...
void Foam::GAMGSolverNew::gatherMatrices
(
...
) const
{
    if (debug)
    {
        Pout<< "GAMGSolverNew::gatherMatrices :"
...
void Foam::GAMGSolverNew::procAgglomerateMatrix
(
